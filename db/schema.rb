...
ActiveRecord::Schema[7.0].define(version: 2023_06_04_052858) do
  ...
  create_table "documentos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.boolean "status"
    t.bigint "user_update_id"
    t.string "comment"
    t.index ["user_id"], name: "index_documentos_on_user_id"
    t.index ["user_update_id"], name: "index_documentos_on_user_update_id"
  end
  ...
  create_table "payments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "verificar"
    t.bigint "user_update_id"
    t.boolean "verificarsub"
    t.string "commentp"
    t.index ["documento_id"], name: "index_payments_on_documento_id"
    t.index ["user_id"], name: "index_payments_on_user_id"
    t.index ["user_update_id"], name: "index_payments_on_user_update_id"
  end
  ...
  add_foreign_key "documentos", "users", column: "user_update_id"
  add_foreign_key "payments", "documentos"
  add_foreign_key "payments", "users"
  add_foreign_key "payments", "users", column: "user_update_id"
end
